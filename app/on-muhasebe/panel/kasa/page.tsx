...
function telefonuWhatsappFormatinaCevir(value: string | null | undefined) {
  ...
  function kasaFisBasligi(hareket: KasaHareketView) {
    return hareket.hareket_turu === "odeme" ? "Ödeme Fişi" : "Tahsilat Fişi";
  }

  function kasaFisTutarEtiketi(hareket: KasaHareketView) {
    return hareket.hareket_turu === "odeme" ? "Ödenen Tutar" : "Tahsil Edilen Tutar";
  }
...
export default function KasaPage() {
  ...
  function tahsilatFisiHtmlOlustur(hareket: KasaHareketView) {
    ...
    const fisBasligi = kasaFisBasligi(hareket);
    const tutarEtiketi = kasaFisTutarEtiketi(hareket);
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[2rem] bg-white p-5 shadow-2xl sm:p-7">
            ...
            <div className="mt-5 rounded-[1.5rem] border border-slate-200 bg-slate-50 p-4">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-[1rem] bg-white p-4">
                  <p className="text-xs font-black text-slate-400">{kasaFisTutarEtiketi(tahsilatFisOnizleme)}</p>
