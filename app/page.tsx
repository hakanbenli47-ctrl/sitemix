...
const wp = {
  genel: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. İşletmem için web sitesi hakkında kısa bilgi almak istiyorum."
  )}`,
  demo: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. İşletmem için ücretsiz demo web sitesi hakkında bilgi almak istiyorum."
  )}`,
  teklif: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. İşletmem için web sitesi/demo hakkında bilgi almak istiyorum."
  )}`,
  referans: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix referanslarını inceledim. Benim işletmem için de benzer bir web sitesi yapılabilir mi?"
  )}`,
  google: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, işletmemin Google’da daha görünür olması için Sitemix web sitesi hakkında bilgi almak istiyorum."
  )}`,
  paketBaslangic: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. Web sitesi kurulum paketi hakkında bilgi almak istiyorum."
  )}`,
  paketTanitim: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. Web sitesi + tanıtım sistemi hakkında bilgi almak istiyorum."
  )}`,
  sonCta: `https://wa.me/${phone}?text=${encodeURIComponent(
    "Merhaba, Sitemix üzerinden geldim. İşletmem için ücretsiz demo hazırlatmak istiyorum."
  )}`,
};

const img = {
  hero:
    "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1000&q=65",
  shop:
    "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=900&q=65",
  web:
    "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=65",
  local:
    "https://images.unsplash.com/photo-1556745757-8d76bdb6984b?auto=format&fit=crop&w=900&q=65",
  phone:
    "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=900&q=65",
};
...
export default function Home() {
  ...
  const live = [
    ...
    "Mobil ziyaretçi bilgi almak istedi",
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0a0706] pb-32 text-[#fff7ed] md:pb-0">
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(251,146,60,0.16),transparent_30%),radial-gradient(circle_at_top_right,rgba(244,63,94,0.12),transparent_32%),radial-gradient(circle_at_bottom,rgba(132,204,22,0.08),transparent_36%),linear-gradient(180deg,#0a0706_0%,#130b09_44%,#050303_100%)]" />
        <div className="absolute inset-0 opacity-[0.09] bg-[linear-gradient(135deg,transparent_0%,transparent_48%,rgba(255,255,255,0.20)_49%,transparent_51%,transparent_100%)] bg-[size:44px_44px]" />
      </div>

      <header className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-[#0a0706]/85 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
          <a href="#" className="flex items-center gap-3">
            <div className="relative grid h-11 w-11 place-items-center overflow-hidden rounded-2xl border border-orange-200/20 bg-orange-300/10">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(251,146,60,0.70),transparent_36%),radial-gradient(circle_at_bottom_right,rgba(244,63,94,0.42),transparent_40%)]" />
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold text-white/45">
                Web sitesi değil, müşteri yolu
              </p>
            </div>
          </a>

          <nav className="hidden items-center gap-8 text-sm font-semibold text-white/58 md:flex">
            <a href="#fark" className="transition hover:text-orange-100">
              Fark
            </a>
            <a href="#referanslar" className="transition hover:text-orange-100">
              Referanslar
            </a>
            <a href="#paketler" className="transition hover:text-orange-100">
              Paketler
            </a>
            <a href="#sss" className="transition hover:text-orange-100">
              SSS
            </a>
          </nav>
          ...
          <a
            href={wp.genel}
            className="rounded-full border border-lime-300/25 bg-lime-300/10 px-4 py-2 text-xs font-black text-lime-100 transition hover:bg-lime-300/16 md:px-5 md:py-3 md:text-sm"
          >
            Bilgi Al
          </a>
        </div>
      ...
      <section className="relative z-10 px-4 pb-16 pt-32 md:px-8 md:pb-24 md:pt-40">
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
          ...
          >
            ...
            >
              Sitemix; işletmen için mobil uyumlu, güven veren ve müşteriyi
              doğrudan WhatsApp’a yönlendiren profesyonel web sitesi hazırlar.
            </motion.p>
                  ...
                  <div>
                    <div className="mb-4 max-w-md rounded-[24px] border border-white/12 bg-black/52 p-5">
                      ...
                      <h3 className="mt-3 text-2xl font-black tracking-[-0.04em]">
                        Google’da ciddi görün. Müşteri güven duysun.
                        WhatsApp’tan yazsın.
                      </h3>
                    </div>
                    ...
                    <div className="mt-4 rounded-[24px] border border-lime-300/18 bg-lime-300/10 p-4">
                      ...
                      <p className="mt-1 text-sm font-black leading-6 text-lime-100">
                        Önce demo hazırlanır. Beğenirsen yayına alma süreci
                        başlar.
                      </p>
                    </div>
                  </div>
      ...
      <section id="fark" className="relative z-10 px-4 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            >
              <p className="text-sm font-black uppercase tracking-[0.28em] text-orange-200">
                Kırılma noktası
              </p>
            ...
            >
              Bizim farkımız sadece tasarım değil. Sayfanın her bölümünü
              müşterinin aklındaki şüpheyi azaltmak ve iletişime geçmesini
              kolaylaştırmak için kuruyoruz.
            </motion.p>
          </div>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {[
              ...
              <div
                key={item.title}
                className="group relative min-h-[330px] overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.045] p-6 transition hover:-translate-y-1 hover:border-orange-200/25 md:min-h-[360px]"
              >
                <div
                ...
                <div className="relative flex h-full min-h-[282px] flex-col justify-between md:min-h-[312px]">
                  <div className="grid h-12 w-12 place-items-center rounded-2xl border border-white/15 bg-black/40 text-sm font-black">
                    0{index + 1}
                  </div>
          ...
          <div className="mt-10 text-center">
            ...
            >
              Benim İşletmeme Uygun Bilgi Al
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-3xl font-black leading-tight tracking-[-0.045em] md:text-5xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {references.map((item) => (
              <a
                ...
                className="group relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.045] p-6 transition hover:-translate-y-1 hover:border-orange-200/25 hover:bg-white/[0.075]"
              >
                ...
                <p className="relative mt-4 text-sm leading-7 text-white/52 md:min-h-[76px]">
                  {item.text}
                </p>
              </a>
            ))}
            ...
            <div
              className="relative overflow-hidden rounded-[30px] border border-lime-300/20 bg-cover bg-center p-6"
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mt-4 text-sm leading-7 text-white/66">
                  Önce demo hazırlanır. Sayfanın nasıl görüneceğini görürsün.
                  Beğenirsen yayın süreci başlar.
                </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((item) => (
              <div
                key={item.no}
                className="relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.045] p-7 transition hover:-translate-y-1 hover:bg-white/[0.075]"
              >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-white/55 md:text-base">
              Her işletme aynı değil. Önce ihtiyacı netleştirip en doğru web ve
              müşteri akışı yapısını kuruyoruz.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {packages.map((item) => (
              <div
                key={item.title}
                className="relative overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.045] p-7 transition hover:-translate-y-1 hover:bg-white/[0.07] md:p-9"
              >
                ...
                <div className="relative mt-8 grid gap-3 sm:grid-cols-2">
                  {item.items.map((listItem) => (
                    <div
                      key={listItem}
                      className="rounded-2xl border border-white/10 bg-black/30 p-4 text-sm font-semibold text-white/68"
                    >
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="space-y-4">
            {faqs.map((item) => (
              <div
                key={item.q}
                className="rounded-[26px] border border-white/10 bg-white/[0.045] p-6"
              >
      ...
      <section className="relative z-10 px-4 pb-36 pt-12 md:px-8 md:pb-28">
        <div
          className="mx-auto max-w-7xl overflow-hidden rounded-[38px] border border-white/10 bg-cover bg-center p-6 text-center shadow-2xl shadow-black/30 md:p-14"
          style={{ backgroundImage: `url(${img.shop})` }}
        >
          <div className="mx-auto max-w-5xl rounded-[30px] border border-white/12 bg-black/72 p-8 md:p-12">
            <p className="text-sm font-black uppercase tracking-[0.28em] text-orange-200">
              Başlayalım
            </p>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-white/62 md:text-base">
              Sayfanın nasıl görüneceğini gör. Beğenirsen revizeleri yapıp
              yayına alma sürecini başlatalım.
            </p>
      ...
      <a
        href={wp.demo}
        className="fixed left-4 right-4 z-50 rounded-2xl border border-lime-300/25 bg-[#14210a]/95 px-5 py-4 text-center text-sm font-black text-lime-100 shadow-xl shadow-lime-500/10 transition hover:bg-[#1f330f] md:left-auto md:right-6 md:w-auto md:rounded-full md:px-5 md:py-3 md:text-xs"
        style={{
